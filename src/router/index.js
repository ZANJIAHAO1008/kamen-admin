...
export const asyncRoutes = [  {
  ...
  children: [
    {
      path: 'manageImage',
      component: () => import('@/views/user/manageImage.vue'),
      name: 'manageImage',
      meta: {
        title: "图片管理",
    ...
    {
      path: 'manageMap',
      component: () => import('@/views/user/manageMap.vue'),
      name: 'manageMap',
      meta: {
        title: "图鉴管理",
    ...
    {
      path: 'manageRadio',
      component: () => import('@/views/user/manageRadio.vue'),
      name: 'manageRadio',
      meta: {
        title: "视频管理",
    ...
    {
      path: 'manageChronicle',
      component: () => import('@/views/user/manageChronicle.vue'),
